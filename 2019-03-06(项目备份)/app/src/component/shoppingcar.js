...
class Shoppingcar extends Component {
    ...
    //删除数据
    trueDel=()=>{
        let {arr,init,toback,tobackobj}=this.props;//这个arr是购物车传过来的 checked是切函数
    ...
    checked=(i)=>{
        ...
        // console.log(dataArr);
        let {arr}=this.props;//这个arr是购物车传过来的 checked是切函数
        dataArr=arr;
    ...
    render() {
        let {arr}=this.props;//这个arr是购物车传过来的 checked是切函数
        // let {count,allprice,dataArr,listarr}=this.state;
        let {display,allnum,allprice,allchecked}=this.state;
        // dataArr=arr;
